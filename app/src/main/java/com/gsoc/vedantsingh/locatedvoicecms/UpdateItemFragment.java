...
import com.gsoc.vedantsingh.locatedvoicecms.beans.TourPOI;
...
public class UpdateItemFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerDragListener {
    ...
    public void AudioPathBehaviour(ViewHolderCategory viewHolder){
...
//        Vedant made a change here, used resource android in stead of resource file which was missing
    ...
    private void setDataToLayout(Cursor query, UpdateItemFragment.ViewHolderCategory viewHolder) {
        ...
        if (query.moveToFirst()) {
            ...
            viewHolder.categoryAudio.setText(query.getString(viewHolder.AUDIOFILEPATH));
